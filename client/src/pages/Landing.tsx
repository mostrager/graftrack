      ...
      <div className="text-center max-w-md">
        <div className="mb-8">
          <div className="w-20 h-20 bg-accent rounded-2xl flex items-center justify-center mx-auto mb-6">
            <SprayCan className="w-10 h-10 text-accent-foreground" />
          </div>
          <h1 className="heading text-4xl font-bold mb-4 text-foreground">
            Graffiti Tracker
          </h1>
          <p className="text-muted-foreground text-lg leading-relaxed">
            Discover and document street art in your city. Track graffiti locations, 
            share photos, and build your personal collection.
          </p>
        </div>
